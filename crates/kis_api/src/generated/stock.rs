...
impl StockTrading {
    ...
    /// [국내주식-001 v1] 주식주문(현금)
    pub async fn order_cash(&self, req: ()) -> Result<serde_json::Value, KisError> {
    ...
    /// [국내주식-002 v1] 주식주문(신용)
    pub async fn order_credit(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_psbl_rvsecncl(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_daily_ccld(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    /// [국내주식-007 v1] 매수가능조회
    pub async fn inquire_psbl_order(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_psbl_sell(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_credit_psamount(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn order_resv_rvsecncl(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_deposit(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_balance_rlz_pl(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_account_balance(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn intgr_margin(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "TTTC0869R",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/trading/intgr-margin", tr_id, req)
            .await
    }
    ...
    pub async fn period_rights(&self, req: ()) -> Result<serde_json::Value, KisError> {
        ...
        self.0
            .post("/uapi/domestic-stock/v1/trading/period-rights", tr_id, req)
            .await
    }
    ...
    /// (야간)선물옵션 주문체결 내역조회 [국내선물-009]
    pub async fn inquire_ngt_ccnl(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    /// (야간)선물옵션 잔고현황 [국내선물-010]
    pub async fn inquire_ngt_balance(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    /// (야간)선물옵션 주문가능 조회 [국내선물-011]
    pub async fn inquire_psbl_ngt_order(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn ngt_margin_detail(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_ccnl_bstime(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_daily_amount_fee(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
...
impl StockQuotations {
    ...
    pub async fn inquire_price(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_price_2(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_daily_price(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_investor(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_member(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_overtime_price(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn exp_closing_price(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    /// ELW 현재가 시세
    pub async fn inquire_elw_price(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_index_price(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_index_daily_price(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_index_tickprice(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_index_timeprice(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn exp_index_trend(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn exp_total_index(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_vi_status(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn comp_interest(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn news_title(&self, req: ()) -> Result<serde_json::Value, KisError> {
        ...
        self.0
            .post("/uapi/domestic-stock/v1/quotations/news-title", tr_id, req)
            .await
    }
    ...
    pub async fn chk_holiday(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "CTCA0903R",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/quotations/chk-holiday", tr_id, req)
            .await
    }
    ...
    pub async fn market_time(&self, req: ()) -> Result<serde_json::Value, KisError> {
        ...
        self.0
            .post("/uapi/domestic-stock/v1/quotations/market-time", tr_id, req)
            .await
    }
    ...
    pub async fn search_info(&self, req: ()) -> Result<serde_json::Value, KisError> {
        ...
        self.0
            .post("/uapi/domestic-stock/v1/quotations/search-info", tr_id, req)
            .await
    }
    ...
    pub async fn search_stock_info(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn credit_by_company(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn estimate_perform(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn lendable_by_company(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn invest_opinion(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn invest_opbysec(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn psearch_title(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn psearch_result(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn intstock_grouplist(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn intstock_multprice(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    /// 국내기관_외국인 매매종목가집계[국내주식-037]
    pub async fn foreign_institution_total(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn frgnmem_trade_estimate(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn frgnmem_pchs_trend(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn frgnmem_trade_trend(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_member_daily(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn program_trade_by_stock(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn investor_trend_estimate(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn inquire_daily_trade_volume(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn comp_program_trade_today(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn comp_program_trade_daily(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn daily_credit_balance(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn exp_price_trend(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn daily_short_sale(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn tradprt_byamt(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn mktfunds(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHKST649100C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/quotations/mktfunds", tr_id, req)
            .await
    }
    ...
    pub async fn daily_loan_trans(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn capture_uplowprice(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn pbar_tratio(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST01130000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/quotations/pbar-tratio", tr_id, req)
            .await
    }
    ...
    pub async fn volume_rank(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST01710000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/quotations/volume-rank", tr_id, req)
            .await
    }
    ...
    pub async fn margin_rate(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn display_board_option_list(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn display_board_top(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn display_board_callput(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn display_board_futures(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
...
impl StockCommon {
    ...
    pub async fn balance_sheet(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHKST66430100",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/finance/balance-sheet", tr_id, req)
            .await
    }
    ...
    pub async fn income_statement(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn financial_ratio(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn profit_ratio(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHKST66430400",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/finance/profit-ratio", tr_id, req)
            .await
    }
    ...
    pub async fn other_major_ratios(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn stability_ratio(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn growth_ratio(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHKST66430800",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/finance/growth-ratio", tr_id, req)
            .await
    }
    ...
    pub async fn dividend(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669102C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/dividend", tr_id, req)
            .await
    }
    ...
    pub async fn purreq(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669103C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/purreq", tr_id, req)
            .await
    }
    ...
    pub async fn merger_split(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669104C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/merger-split", tr_id, req)
            .await
    }
    ...
    pub async fn rev_split(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669105C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/rev-split", tr_id, req)
            .await
    }
    ...
    pub async fn cap_dcrs(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669106C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/cap-dcrs", tr_id, req)
            .await
    }
    ...
    pub async fn list_info(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669107C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/list-info", tr_id, req)
            .await
    }
    ...
    pub async fn pub_offer(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669108C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/pub-offer", tr_id, req)
            .await
    }
    ...
    pub async fn forfeit(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669109C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/forfeit", tr_id, req)
            .await
    }
    ...
    pub async fn mand_deposit(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669110C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/mand-deposit", tr_id, req)
            .await
    }
    ...
    pub async fn paidin_capin(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669100C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/paidin-capin", tr_id, req)
            .await
    }
    ...
    pub async fn bonus_issue(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669101C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/bonus-issue", tr_id, req)
            .await
    }
    ...
    pub async fn sharehld_meet(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB669111C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ksdinfo/sharehld-meet", tr_id, req)
            .await
    }
}
...
impl StockRanking {
    ...
    pub async fn overtime_exp_trans_fluct(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn fluctuation(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST01700000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/fluctuation", tr_id, req)
            .await
    }
    ...
    pub async fn quote_balance(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST01720000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/quote-balance", tr_id, req)
            .await
    }
    ...
    pub async fn profit_asset_index(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn market_cap(&self, req: ()) -> Result<serde_json::Value, KisError> {
        ...
        self.0
            .post("/uapi/domestic-stock/v1/ranking/market-cap", tr_id, req)
            .await
    }
    ...
    pub async fn finance_ratio(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST01750000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/finance-ratio", tr_id, req)
            .await
    }
    ...
    pub async fn after_hour_balance(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn prefer_disparate_ratio(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn disparity(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST01780000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/disparity", tr_id, req)
            .await
    }
    ...
    pub async fn market_value(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST01790000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/market-value", tr_id, req)
            .await
    }
    ...
    pub async fn volume_power(&self, req: ()) -> Result<serde_json::Value, KisError> {
        ...
        self.0
            .post("/uapi/domestic-stock/v1/ranking/volume-power", tr_id, req)
            .await
    }
    ...
    pub async fn top_interest_stock(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn exp_trans_updown(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn traded_by_company(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn near_new_highlow(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn dividend_rate(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "HHKDB13470100",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/dividend-rate", tr_id, req)
            .await
    }
    ...
    pub async fn bulk_trans_num(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHKST190900C0",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/bulk-trans-num", tr_id, req)
            .await
    }
    ...
    pub async fn credit_balance(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHKST17010000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/credit-balance", tr_id, req)
            .await
    }
    ...
    pub async fn short_sale(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
            crate::client::KisEnv::Real => "FHPST04820000",
            crate::client::KisEnv::Vts => "모의투자 미지원",
        };
        self.0
            .post("/uapi/domestic-stock/v1/ranking/short-sale", tr_id, req)
            .await
    }
    ...
    pub async fn overtime_fluctuation(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn overtime_volume(&self, req: ()) -> Result<serde_json::Value, KisError> {
        let tr_id = match self.0.env() {
    ...
    pub async fn hts_top_view(&self, req: ()) -> Result<serde_json::Value, KisError> {
        ...
        self.0
            .post("/uapi/domestic-stock/v1/ranking/hts-top-view", tr_id, req)
            .await
    }
}
