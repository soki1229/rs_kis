...
mod real {
    ...
    mod stock {
        ...
        async fn test_inquire_psbl_rvsecncl() {
            ...
            println!("API 주식정정취소가능주문조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_psbl_sell() {
            ...
            println!("API 매도가능수량조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_credit_psamount() {
            ...
            println!("API 신용매수가능조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_order_resv_ccnl() {
            ...
            println!("API 주식예약주문조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_present_balance() {
            ...
            println!("API 퇴직연금 체결기준잔고 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_daily_ccld_next() {
            ...
            println!("API 퇴직연금 미체결내역 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_psbl_order_next() {
            ...
            println!("API 퇴직연금 매수가능조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_deposit() {
            ...
            println!("API 퇴직연금 예수금조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_balance_next() {
            ...
            println!("API 퇴직연금 잔고조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_balance_rlz_pl() {
            ...
            println!("API 주식잔고조회_실현손익 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_account_balance() {
            ...
            println!("API 투자계좌자산현황조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_period_profit() {
            ...
            println!("API 기간별손익일별합산조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_period_trade_profit() {
            ...
            let result = client.stock().trading().inquire_period_trade_profit(arg).await;
            println!("API 기간별매매손익현황조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_intgr_margin() {
            ...
            println!("API 주식통합증거금 현황 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_period_rights() {
            ...
            println!("API 기간별계좌권리현황조회 status: {:?}", result.is_ok() || result.is_err());
        }
        }
        mod quotations {
            use super::*;
        ...
        async fn test_inquire_price_2() {
            ...
            println!("API 주식현재가 시세2 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_time_dailychartprice() {
            ...
            let result = client.stock().quotations().inquire_time_dailychartprice(arg).await;
            println!("API 주식일별분봉조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_overtime_price() {
            ...
            let result = client.stock().quotations().inquire_overtime_price(arg).await;
            println!("API 국내주식 시간외현재가 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_overtime_asking_price() {
            ...
            let result = client.stock().quotations().inquire_overtime_asking_price(arg).await;
            println!("API 국내주식 시간외호가 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_exp_closing_price() {
            ...
            println!("API 국내주식 장마감 예상체결가 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_index_price() {
            ...
            println!("API 국내업종 현재지수 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_index_daily_price() {
            ...
            let result = client.stock().quotations().inquire_index_daily_price(arg).await;
            println!("API 국내업종 일자별지수 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_index_tickprice() {
            ...
            let result = client.stock().quotations().inquire_index_tickprice(arg).await;
            println!("API 국내업종 시간별지수(초) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_index_timeprice() {
            ...
            let result = client.stock().quotations().inquire_index_timeprice(arg).await;
            println!("API 국내업종 시간별지수(분) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_time_indexchartprice() {
            ...
            let result = client.stock().quotations().inquire_time_indexchartprice(arg).await;
            println!("API 업종 분봉조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_index_category_price() {
            ...
            let result = client.stock().quotations().inquire_index_category_price(arg).await;
            println!("API 국내업종 구분별전체시세 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_exp_index_trend() {
            ...
            println!("API 국내주식 예상체결지수 추이 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_exp_total_index() {
            ...
            println!("API 국내주식 예상체결 전체지수 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_vi_status() {
            ...
            println!("API 변동성완화장치(VI) 현황 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_comp_interest() {
            ...
            println!("API 금리 종합(국내채권/금리) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_news_title() {
            ...
            println!("API 종합 시황/공시(제목) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_chk_holiday() {
            ...
            println!("API 국내휴장일조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_market_time() {
            ...
            println!("API 국내선물 영업일조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_search_info() {
            ...
            println!("API 상품기본조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_search_stock_info() {
            ...
            println!("API 주식기본조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_credit_by_company() {
            ...
            println!("API 국내주식 당사 신용가능종목 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_estimate_perform() {
            ...
            println!("API 국내주식 종목추정실적 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_lendable_by_company() {
            ...
            println!("API 당사 대주가능 종목 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_invest_opinion() {
            ...
            println!("API 국내주식 종목투자의견 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_invest_opbysec() {
            ...
            println!("API 국내주식 증권사별 투자의견 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_psearch_title() {
            ...
            println!("API 종목조건검색 목록조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_psearch_result() {
            ...
            println!("API 종목조건검색조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_intstock_grouplist() {
            ...
            println!("API 관심종목 그룹조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_intstock_multprice() {
            ...
            println!("API 관심종목(멀티종목) 시세조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_intstock_stocklist_by_group() {
            ...
            let result = client.stock().quotations().intstock_stocklist_by_group(arg).await;
            println!("API 관심종목 그룹별 종목조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_foreign_institution_total() {
            ...
            let result = client.stock().quotations().foreign_institution_total(arg).await;
            println!("API 국내기관_외국인 매매종목가집계 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_frgnmem_trade_estimate() {
            ...
            let result = client.stock().quotations().frgnmem_trade_estimate(arg).await;
            println!("API 외국계 매매종목 가집계 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_investor_trade_by_stock_daily() {
            ...
            let result = client.stock().quotations().investor_trade_by_stock_daily(arg).await;
            println!("API 종목별 투자자매매동향(일별) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_investor_time_by_market() {
            ...
            let result = client.stock().quotations().inquire_investor_time_by_market(arg).await;
            println!("API 시장별 투자자매매동향(시세) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_investor_daily_by_market() {
            ...
            let result = client.stock().quotations().inquire_investor_daily_by_market(arg).await;
            println!("API 시장별 투자자매매동향(일별) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_frgnmem_pchs_trend() {
            ...
            println!("API 종목별 외국계 순매수추이 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_frgnmem_trade_trend() {
            ...
            println!("API 회원사 실시간 매매동향(틱) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_member_daily() {
            ...
            println!("API 주식현재가 회원사 종목매매동향 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_program_trade_by_stock() {
            ...
            let result = client.stock().quotations().program_trade_by_stock(arg).await;
            println!("API 종목별 프로그램매매추이(체결) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_program_trade_by_stock_daily() {
            ...
            let result = client.stock().quotations().program_trade_by_stock_daily(arg).await;
            println!("API 종목별 프로그램매매추이(일별) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_investor_trend_estimate() {
            ...
            let result = client.stock().quotations().investor_trend_estimate(arg).await;
            println!("API 종목별 외인기관 추정가집계 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_daily_trade_volume() {
            ...
            let result = client.stock().quotations().inquire_daily_trade_volume(arg).await;
            println!("API 종목별일별매수매도체결량 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_comp_program_trade_today() {
            ...
            let result = client.stock().quotations().comp_program_trade_today(arg).await;
            println!("API 프로그램매매 종합현황(시간) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_comp_program_trade_daily() {
            ...
            let result = client.stock().quotations().comp_program_trade_daily(arg).await;
            println!("API 프로그램매매 종합현황(일별) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_investor_program_trade_today() {
            ...
            let result = client.stock().quotations().investor_program_trade_today(arg).await;
            println!("API 프로그램매매 투자자매매동향(당일) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_daily_credit_balance() {
            ...
            println!("API 국내주식 신용잔고 일별추이 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_exp_price_trend() {
            ...
            println!("API 국내주식 예상체결가 추이 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_daily_short_sale() {
            ...
            println!("API 국내주식 공매도 일별추이 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_tradprt_byamt() {
            ...
            println!("API 국내주식 체결금액별 매매비중 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_mktfunds() {
            ...
            println!("API 국내 증시자금 종합 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_daily_loan_trans() {
            ...
            println!("API 종목별 일별 대차거래추이 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_capture_uplowprice() {
            ...
            println!("API 국내주식 상하한가 포착 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_pbar_tratio() {
            ...
            println!("API 국내주식 매물대/거래비중 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_volume_rank() {
            ...
            println!("API 거래량순위 status: {:?}", result.is_ok() || result.is_err());
        }
        }
        mod finance {
            use super::*;
        ...
        async fn test_balance_sheet() {
            ...
            println!("API 국내주식 대차대조표 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_income_statement() {
            ...
            println!("API 국내주식 손익계산서 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_financial_ratio() {
            ...
            println!("API 국내주식 재무비율 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_profit_ratio() {
            ...
            println!("API 국내주식 수익성비율 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_other_major_ratios() {
            ...
            println!("API 국내주식 기타주요비율 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_stability_ratio() {
            ...
            println!("API 국내주식 안정성비율 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_growth_ratio() {
            ...
            println!("API 국내주식 성장성비율 status: {:?}", result.is_ok() || result.is_err());
        }
        }
        mod ksdinfo {
            use super::*;
        ...
        async fn test_dividend() {
            ...
            println!("API 예탁원정보(배당일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_purreq() {
            ...
            println!("API 예탁원정보(주식매수청구일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_merger_split() {
            ...
            println!("API 예탁원정보(합병/분할일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_rev_split() {
            ...
            println!("API 예탁원정보(액면교체일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_cap_dcrs() {
            ...
            println!("API 예탁원정보(자본감소일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_list_info() {
            ...
            println!("API 예탁원정보(상장정보일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_pub_offer() {
            ...
            println!("API 예탁원정보(공모주청약일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_forfeit() {
            ...
            println!("API 예탁원정보(실권주일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_mand_deposit() {
            ...
            println!("API 예탁원정보(의무예치일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_paidin_capin() {
            ...
            println!("API 예탁원정보(유상증자일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_bonus_issue() {
            ...
            println!("API 예탁원정보(무상증자일정) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_sharehld_meet() {
            ...
            println!("API 예탁원정보(주주총회일정) status: {:?}", result.is_ok() || result.is_err());
        }
        }
        mod ranking {
            use super::*;
        ...
        async fn test_overtime_exp_trans_fluct() {
            ...
            println!("API 국내주식 시간외예상체결등락률 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_fluctuation() {
            ...
            println!("API 국내주식 등락률 순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_quote_balance() {
            ...
            println!("API 국내주식 호가잔량 순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_profit_asset_index() {
            ...
            println!("API 국내주식 수익자산지표 순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_market_cap() {
            ...
            println!("API 국내주식 시가총액 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_finance_ratio() {
            ...
            println!("API 국내주식 재무비율 순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_after_hour_balance() {
            ...
            println!("API 국내주식 시간외잔량 순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_prefer_disparate_ratio() {
            ...
            println!("API 국내주식 우선주/괴리율 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_disparity() {
            ...
            println!("API 국내주식 이격도 순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_market_value() {
            ...
            println!("API 국내주식 시장가치 순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_volume_power() {
            ...
            println!("API 국내주식 체결강도 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_top_interest_stock() {
            ...
            println!("API 국내주식 관심종목등록 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_exp_trans_updown() {
            ...
            println!("API 국내주식 예상체결 상승/하락상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_traded_by_company() {
            ...
            println!("API 국내주식 당사매매종목 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_near_new_highlow() {
            ...
            println!("API 국내주식 신고/신저근접종목 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_dividend_rate() {
            ...
            println!("API 국내주식 배당률 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_bulk_trans_num() {
            ...
            println!("API 국내주식 대량체결건수 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_credit_balance() {
            ...
            println!("API 국내주식 신용잔고 상위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_short_sale() {
            ...
            println!("API 국내주식 공매도 상위종목 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_overtime_fluctuation() {
            ...
            println!("API 국내주식 시간외등락율순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_overtime_volume() {
            ...
            println!("API 국내주식 시간외거래량순위 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_hts_top_view() {
            ...
            println!("API HTS조회상위20종목 status: {:?}", result.is_ok() || result.is_err());
        }
        }
    }
}
mod vts {
    ...
    mod stock {
        ...
        async fn test_inquire_daily_ccld() {
            ...
            println!("API 주식일별주문체결조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_balance() {
            ...
            println!("API 주식잔고조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_psbl_order() {
            ...
            println!("API 매수가능조회 status: {:?}", result.is_ok() || result.is_err());
        }
        }
        mod quotations {
            use super::*;
        ...
        async fn test_inquire_price() {
            ...
            println!("API 주식현재가 시세 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_ccnl() {
            ...
            println!("API 주식현재가 체결 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_daily_price() {
            ...
            println!("API 주식현재가 일자별 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_asking_price_exp_ccn() {
            ...
            let result = client.stock().quotations().inquire_asking_price_exp_ccn(arg).await;
            println!("API 주식현재가 호가/예상체결 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_investor() {
            ...
            println!("API 주식현재가 투자자 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_member() {
            ...
            println!("API 주식현재가 회원사 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_daily_itemchartprice() {
            ...
            let result = client.stock().quotations().inquire_daily_itemchartprice(arg).await;
            println!("API 국내주식기간별시세(일/주/월/년) status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_time_itemchartprice() {
            ...
            let result = client.stock().quotations().inquire_time_itemchartprice(arg).await;
            println!("API 주식당일분봉조회 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_time_itemconclusion() {
            ...
            let result = client.stock().quotations().inquire_time_itemconclusion(arg).await;
            println!("API 주식현재가 당일시간대별체결 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_daily_overtimeprice() {
            ...
            let result = client.stock().quotations().inquire_daily_overtimeprice(arg).await;
            println!("API 주식현재가 시간외일자별주가 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_time_overtimeconclusion() {
            ...
            let result = client.stock().quotations().inquire_time_overtimeconclusion(arg).await;
            println!("API 주식현재가 시간외시간별체결 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_elw_price() {
            ...
            println!("API ELW 현재가 시세 status: {:?}", result.is_ok() || result.is_err());
        }
        ...
        async fn test_inquire_daily_indexchartprice() {
            ...
            let result = client.stock().quotations().inquire_daily_indexchartprice(arg).await;
            println!("API 국내주식업종기간별시세(일/주/월/년) status: {:?}", result.is_ok() || result.is_err());
        }
        }
    }
}
